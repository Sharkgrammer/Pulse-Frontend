<template>
  ...
  <div class="fixed h-full w-full z-0" v-if="popup" :key="popup">
    ...
    <div class="fixed grid grid-cols-5 lg:grid-cols-6 bg-lightBg dark:bg-darkBg border-t border-gray-700 dark:border-gray-300 h-32 bottom-0 w-full">

      <div class="lg:col-start-2 col-span-3 text-gray-800 dark:text-gray-200 flex items-center">
        <p>
          Pulse uses cookie technology to make your experience better. You can read our privacy policy at this <a href="#">link</a>.
